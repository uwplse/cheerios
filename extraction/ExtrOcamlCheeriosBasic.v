...
Extract Inlined Constant
        IOStreamWriter.t => "Serializer_primitives.serializer".
Extract Inlined Constant
        IOStreamWriter.wire => "Serializer_primitives.wire".
...
Extract Inlined Constant IOStreamWriter.empty_unwrap => "Obj.magic".
Extract Inlined Constant IOStreamWriter.putByte_unwrap => "Obj.magic".
Extract Inlined Constant IOStreamWriter.append_unwrap => "Obj.magic".
Extract Inlined Constant IOStreamWriter.wire_wrap_unwrap => "Obj.magic".
